    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        {isLoading ? (
          ...
          <FlatList data={filteredVenues} keyExtractor={(item) => item._id || item.id} renderItem={renderStoreCard} contentContainerStyle={styles.storeList} showsVerticalScrollIndicator={false} />
        )}
      </SafeAreaView>
    );
  }
